...
class TestSettings:
    ...
    def test_default_settings(self):
        ...
        try:
            ...
            assert test_settings.API_DESCRIPTION == "API de segmentation sémantique pour les images urbaines utilisant un modèle U-Net"
    ...
    def test_environment_variables(self):
        ...
        try:
            ...
            # assert test_settings.HOST == "127.0.0.1"  # Ceci ne fonctionne pas car HOST n'est pas une propriété
            assert test_settings.PORT == 9000
            assert test_settings.RELOAD is False
            # LOG_LEVEL n'est pas une propriété, donc il utilise la valeur par défaut
            # assert test_settings.LOG_LEVEL == "debug"  # Ceci ne fonctionne pas car LOG_LEVEL n'est pas une propriété
    ...
    def test_class_names_configuration(self):
        ...
        expected_classes = [
            'road', 'building', 'car', 'traffic_sign', 
            'person', 'vegetation', 'sky', 'background'
        ]
