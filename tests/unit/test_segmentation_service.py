...
class TestSegmentationService:
    ...
    def service(self, mock_model):
        ...
        with patch('app.services.segmentation_service.tf.keras.models.load_model', return_value=mock_model):
    ...
    def test_get_segmentation_stats(self, service):
        ...
        assert abs(total_percentage - 100.0) < 0.1  # Tolérance plus large pour les erreurs d'arrondi
    ...
    def test_class_names_consistency(self, service):
        ...
        expected_names = ['road', 'building', 'car', 'traffic_sign', 
